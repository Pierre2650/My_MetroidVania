...
public abstract class Enemy : MonoBehaviour
{
    ...
    protected void spawnCurrency(char type)
    {
        //to modify, can create a big soul
        int n;
        switch (type){
            case 'E':
                //Easy enemy
            ...
            case 'M':
                ...
                n = UnityEngine.Random.Range(3, 7);
                for (int i = 0; i < n; i++)
                {
                    Instantiate(currencyPrefab, this.transform.position, this.transform.rotation);
                }
            ...
            case 'H':
                ...
                n = UnityEngine.Random.Range(6, 10);
                for (int i = 0; i < n; i++)
                {
                    Instantiate(currencyPrefab, this.transform.position, this.transform.rotation);
                }
            ...
            case 'C':
                ...
                n = UnityEngine.Random.Range(9, 15);
                for (int i = 0; i < n; i++)
                {
                    Instantiate(currencyPrefab, this.transform.position, this.transform.rotation);
                }
